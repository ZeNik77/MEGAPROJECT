...
class MyWidget(QMainWindow, Form):
    def __init__(self):
        ...
        for i in self.tabs:
            i.hide()
            self.flag[i] = False
        self.arr_lbl = [self.label_name, self.label_buttons, self.label_devs, self.btn_todo, self.btn_inprocess,
        ...
        self.arr_GB = [self.groupBox_2, self.groupBox_3, self.groupBox_4]
        self.btns_init()
        self.fonts_init()
